# Generated by Django 4.1 on 2023-12-01 09:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Draft', 'Draft'), ('Saved', 'Saved'), ('Invoiced', 'Invoiced')], default='Draft', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.CharField(default='', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Draft', 'Draft'), ('Saved', 'Saved')], default='Draft', max_length=150, null=True)),
                ('cid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.company')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Draft', 'Draft'), ('Billed', 'Billed')], default='Billed', max_length=150)),
                ('cid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.company')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance_amount', models.FloatField(blank=True, null=True)),
                ('payment_type', models.CharField(max_length=100, null=True)),
                ('status', models.CharField(choices=[('Draft', 'Draft'), ('Save', 'Save')], default='Draft', max_length=150)),
                ('cid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.company')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shippincode', models.CharField(max_length=100, null=True)),
                ('shipcountry', models.CharField(max_length=100, null=True)),
                ('opening_balance_type', models.CharField(blank=True, max_length=10, null=True)),
                ('attachment', models.ImageField(null=True, upload_to='vendor-files/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock_rate', models.FloatField(blank=True, default='0.0', null=True)),
                ('status', models.CharField(max_length=100, null=True)),
                ('cid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.company')),
            ],
        ),
